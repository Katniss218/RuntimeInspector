...
namespace RuntimeInspector.UI.Drawers
{
    ...
    public class Int32Drawer : Drawer
    {
        public override (RectTransform, UIObjectGraphBinding) Draw( RectTransform parent, ObjectGraphNode binding, InspectorStyle style )
        {
            ...
            {
                (RectTransform, UIObjectGraphBinding) obj = InspectorFieldOrProperty.Create( redrawData.Binding.Root, AssetRegistry<Sprite>.GetAsset( "RuntimeInspector/Sprites/icon_int32" ), binding, style );
